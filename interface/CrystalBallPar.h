...
{
  public:
    CrystalBallPar(int parNumber, int decayMode, const std::string& jetParFileName); // apply 1 correction level at a time
    CrystalBallPar(int parNumber, int decayMode, const std::string& l2JetParFileName, const std::string& l3JetParFileName); // 2 correction levels
